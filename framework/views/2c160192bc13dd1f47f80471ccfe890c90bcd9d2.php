...
<div id="cartModal" class="cart-modal">
 ...
 $('.PayNow-cart').on('click', function() {
    const totalAmount = parseFloat($('#totalAmount').text()); // Get the total amount from your cart
    console.log(totalAmount); // Log total amount to check if it's correct
    ...
    var options = {
        "key": "rzp_test_DrASf34mihEAtB", // Your Razorpay key
        "amount": totalAmount * 100, // Amount in paise (totalAmount * 100)
        "currency": "INR",
        "name": "Wood Furniture",
        "description": "Order Payment",
        "image": "images/furniture_logo-removebg-preview.png", // Optional: Your logo image
        "handler": function(response) {
            console.log(response); // Log the response to debug
            alert("Payment successful!");
            // Add code to store payment details in your database here
        },
        "prefill": {
            "name": "Shyam", // You can dynamically fill the user's name here
            "email": "user@example.com", // Dynamically fetch the user's email
            "contact": "+911234567890" // Dynamically fetch the user's contact number
        },
        "theme": {
